        ...
        <div className={styles.topmenuwrapper}>
          ...
          <div className={styles.menulisting}>
            <button
              ...
              style={activetab==="Dashboard"?{background:"#ece1ff", color:"#7654ee", fontWeight:'600'}:{}}
            ...
            <button
             className={styles.tabbtn}
             style={activetab==="Interested Users"?{background:"#ece1ff", color:"#7654ee", fontWeight:'600'}:{}}
        ...
        <div className={styles.analyticscontainer}>
          ...
          <div className={styles.overviewboxses}>
            ...
            <div className={styles.overviewbox}>
              ...
              <h3 className={styles.metric}>
                {" "}
                {performancedata?.overview?.topSource || 0}{" "}
              </h3>
            </div>
            ...
            <div className={styles.overviewbox}>
              ...
              <h3 className={styles.metric}>
                {" "}
                {performancedata?.overview?.topDevice || 0}{" "}
              </h3>
            </div>
            ...
            <div className={styles.overviewbox}>
              ...
              <h3 className={styles.metric}>
                {" "}
                {performancedata?.overview?.topRegion || 0}{" "}
              </h3>
            </div>
          </div>
                ...
                return (
                  <div className={styles.content}>
                    <div className={styles.iconbox}>
                      {element.source === "instagram" ? (
                        <img src={instaicon} alt="source image" />
                      ) : (
                        ""
                      )}
                      {element.source === "qr" ? (
                        <img src={qrcodeicon} alt="source image" />
                      ) : (
                        ""
                      )}
                      {element.source === "facebook" ? (
                        <img src={facebookicon} alt="source image" />
                      ) : (
                        ""
                      )}
                      {element.source === "direct" ? (
                        <img src={qrcodeicon} alt="source image" />
                      ) : (
                        ""
                      )}
                      {element.source === "other" ? (
                        <img src={linkIcon} alt="source image" />
                      ) : (
                        ""
                      )}
                      <p> {element.source || ""}</p>
                    ...
                    <div className={styles.numbersbox}>
                      <p> {element.count || 0} </p>
                      <p className={styles.percentagebtn}>
                        {" "}
                        {Math.round(element.percentage) || 0}%{" "}
                      </p>
                    </div>
                  </div>
                );
              ...
              {performancedata?.deviceDistribution?.map((element) => {
                return (
                  <div className={styles.content}>
                    <div className={styles.iconbox}>
                      {element.device === "ios" ? (
                        <img src={iosicon} alt="source image" />
                      ) : (
                        ""
                      )}
                      {element.device === "android" ? (
                        <img src={androidicon} alt="source image" />
                      ) : (
                        ""
                      )}
                      {element.device === "windows" ? (
                        <img src={windowsIcon} alt="source image" />
                      ) : (
                        ""
                      )}
                      {element.device === "web" ? (
                      ...
                      {element.device === "linux" ? (
                        <img src={linuxIcon} alt="source image" />
                      ) : (
                        ""
                      )}
                      <p> {element.device || ""}</p>
              ...
              {performancedata?.regionDistribution?.map((element) => {
                return (
                  <div className={styles.content}>
                    <div className={styles.iconbox}>
                      {element.region === "IN" ? (
                        <img src={indianflag} alt="source image" />
                      ) : (
                        ""
                      )}
                      {element.region === "USA" || element.region === "US" ? (
                        <img src={usaflag} alt="source image" />
                      ) : (
                        ""
                      )}
                      {element.region === "ZA" ? (
                        <img src={southafricanflag} alt="source image" />
                      ) : (
                        ""
                      )}
                      <p> {element.region || "N/A"} </p>
                    </div>
                    <div className={styles.numbersbox}>
                      <p> {element.count || 0} </p>
                      <p className={styles.percentagebtn}>
