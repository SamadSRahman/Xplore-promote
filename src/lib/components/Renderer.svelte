<script lang="ts">
  ...
  function onUploadImage(): void {
    ...
    } else if (processedJson.type === "video") {
      subtype = "image" as const;
      title = $l10n("props.video_sources");
      url = processedJson.video_sources[0].url;
    ...
    >
      ...
      {#if highlights}
        {#each highlights as highlight (highlight.elem)}
          {#if highlight.emptyFileType === "video"}
            <div
              class="renderer__highlight-inner"
            ...
            >
              <!-- Render the video element when the item is a video -->
              <video
                controls
                style:left="{highlight.left + highlight.margins.left}px"
                style:top="{highlight.top + highlight.margins.top}px"
                ...
                poster="https://static.vecteezy.com/system/resources/thumbnails/004/688/392/small_2x/sr-minimalist-serif-modern-letter-logo-in-black-and-white-sr-creative-serif-logo-design-icon-vector.jpg"
              ...
              >
                ...
                >
                  ...
                  {#if highlight.isRotate}
                    ...
                    >
                      <path
                        d="M 32 {32 - 24} A 24 24 0 {componentCloneRotation >=
                        180
                          ? 1
                          : 0} 0 {32 +
                          24 *
                          ...
                          24 *
                            Math.sin(degToRad(-componentCloneRotation - 90))}"
                        class="renderer__highlight-rotate-arc"
                        stroke-width="3"
                        stroke-linecap="round"
                        fill="none"
                  ...
                  {#if highlight.emptyFileType && !$readOnly}
                    <button
                      class="renderer__upload-file"
                      class:renderer__upload-file_big={highlight.widthNum >=
                        220}
                      style:--rotation="{-highlight.rotation}deg"
                      on:click={onUploadImage}
                    >
